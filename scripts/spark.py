...
class Spark:
  ...
  def update(self):
    ...
    # size is proportional to the speed; speed is its timer
  ...
  def render(self, surf, offset=(0, 0)):
    render_points = [
      ...
      (self.pos[0] + math.cos(self.angle + math.pi / 2) * self.speed * 0.5 - offset[0],
       self.pos[1] + math.sin(self.angle + math.pi / 2) * self.speed * 0.5 - offset[1]),
